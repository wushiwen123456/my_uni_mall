<template>
	...
	<view class="container">
		...
		<view class="mp-search-box">
			<input type="text" class="ser-input" value="输入关键字搜索" disabled />			
		</view>
		<!-- #endif -->
		...
		<view class="cate-section">
			...
			<view class="cate-item">
				<image src="/static/temp/c6.png" mode=""></image>
				<text>营养保健</text>
			</view>
			<view class="cate-item">
			...
			<view class="cate-item">
				<image src="/static/temp/c8.png" mode=""></image>
				<text>素食生鲜</text>
			</view>
		</view>
		<!-- ad1 -->
		<view class="ad1">
			<image src="../../static/temp/ad1.jpg" mode="aspectFill"></image>
		</view>
		
		<!-- 秒杀专区 -->
		<view class="skill-section m-t">
			<view class="s-header">
				<image class="s-img" src="/static/temp/secskill-img.jpg" mode="widthFix"></image>
				<text class="tip">8点场</text>
				<!-- 倒计时组件 -->
				<uni-countdown :show-day="false" :hour="2" :minute="2" :second="30"
					color="#ffffff" background-color="rgba(216,61,92,1)"/>
			</view>
	...
	export default {
		...
		methods:{
			...
			swiperChange(e){
				...
				this.titleNViewBackground = this.carouselList[this.swiperCurrent].background
			},
...
<style lang="scss">
	...
	.cate-section{
		...
		image{
			...
			border-radius: 50%;
			opacity: .7;
			box-shadow: 4upx 4upx 20upx rgba(20,67,106,.3);
		}
	}
	.ad1{
		width: 100%;
